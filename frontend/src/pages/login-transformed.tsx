...
import { EyeIcon, EyeSlashIcon, SparklesIcon, XCircleIcon } from '@heroicons/react/24/outline';
...
const Login: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Sign In - ProtoThrive</title>
        <meta name="description" content="Sign in to your ProtoThrive account and continue building with AI." />
      </Head>
